 ...
 * los impares mostrados en orden descendente.
 * Versión 1.0
 * @author Euris Alc.
 */
public class Practica_Entorno {
    ...
    public void IngresarNumero() {
        do {
            ...
            try {
                ...
                System.out.println("------------------------------");
                // Recorre los elementos introducidos por medio del bucle for.
    ...
    public void OrdenarNumeros() {
        Arrays.sort(numeros);
        System.out.println("-----------------------------------------------------------------------------");
        System.out.println("Orden ascendente de los números introducidos: " + Arrays.toString(numeros));
        System.out.println("-----------------------------------------------------------------------------");
    }
     /**
     * Tercer método: Divide por dos los valores almacenados en el
     * array, clasifica los que son parese e impares y los ordena
